...
?>
    ...
    <td colspan="4"><a href="#" class="btn btn-primary" id="user_user_edit" onclick="user_edit()">&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</a><input class="btn btn-primary" id="user_user_update_btn" type="submit" name="lastname_update" value="Update"></td>
    </tr>
    </div>
    </form>
    ...
    <td>&nbsp;<input type="radio" name="gender" value="male" <?php if($gender == "male") {echo "checked";} ?> id="gender" required disabled>Male <br> &nbsp;<input type="radio" name="gender" value="female" <?php if($gender == "female") {echo "checked";} ?> required disabled>Female</td>
    
    <td class="label"><b><label for="civilStatus">Civil Status:</label></b></td>
    <td>&nbsp;<input type="radio" name="civilStatus" value="single" <?php if($civilStatus == "single") {echo "checked";} ?> id="civilStatus" required disabled>Single <br> &nbsp;<input type="radio" name="civilStatus" value="married" <?php if($civilStatus == "married") {echo "checked";} ?> required disabled>Married</td>
    </tr>
    </div>
    </table>
        </div>
    ...
    <div class="card">
      <div class="card-header">
        <a class="collapsed card-link collapse_block" data-toggle="collapse" href="#elementary">
    ...
    <div class="card">
      <div class="card-header">
        <a class="collapsed card-link collapse_block" data-toggle="collapse" href="#highschool">
    ...
    <div class="card">
      <div class="card-header">
        <a class="collapsed card-link collapse_block" data-toggle="collapse" href="#college">
    ...
    <div class="card">
      <div class="card-header">
        <a class="collapsed card-link collapse_block" data-toggle="collapse" href="#collapseNine">
...
<script>
function user_edit(){
    var edit = document.getElementById("user_user_edit");
    var update_btn = document.getElementById("user_user_update_btn");
    var user_settings = document.getElementById("lastname");
